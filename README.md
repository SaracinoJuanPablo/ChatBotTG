...
<img width="1408" height="768" alt="Gemini_Generated_Image_plpa8hplpa8hplpa" src="https://github.com/user-attachments/assets/ecd34409-121b-43f7-92c6-4edebe581517" />
...
2. **Configurar entorno:**
   ...
   ```env
   # Accesos de Telegram
   TELEGRAM_BOT_TOKEN=tu_token_de_botfather #Entra a TG busca @BotFather, escribe el comando /newbot
   ADMIN_USER_ID=tu_user_id_de_telegram #Entra a TG busca @userinfobot, escribe el comando /start
   ...
   _Nota: Si ejecutas de manera nativa (sin Docker) puede que debas colocar la ruta absoluta de Windows/Linux hacia tu carpeta "knowledge"_.
...
2. Inicia un chat dándole una directiva en lenguaje natural. Ejemplos de lo que puedes hacer:
   - _"Lee mi archivo tareas.txt y dime qué tengo pendiente."_
   - _"Agrega una nueva fila al Excel de 'ventas.xlsx' con los valores: 25/10/2023, Servicio de IT, $1500."_
   - _"Reemplaza en mi documento 'contrato.docx' la palabra '[CLIENTE]' por 'Empresa ACME'."_
